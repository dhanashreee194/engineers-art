  ...
  items: [
    {
      ...
      blurb: 'Homes that need smarter storage and durable fittings.',
      image: media.bedroom,
    },
    {
      title: 'Office',
      href: '/industries/office',
      blurb: 'Workspaces that demand modular, easy-to-maintain systems.',
      image: media.quality,
    },
    {
      title: 'Hospitality',
      href: '/industries/hospitality',
      blurb: 'Guest-facing durability with refined presentation.',
      image: media.workshop,
    },
    {
      title: 'Institutional',
      href: '/industries/institutional',
      blurb: 'Schools, clinics, and campuses with heavy daily use.',
      image: media.about,
    },
    {
      title: 'Commercial',
      href: '/industries/commercial',
      blurb: 'Retail and commercial sites needing reliable fabrication.',
      image: media.living,
    },
    {
      title: 'Custom OEM',
      href: '/industries/custom-oem',
      blurb: 'Partner builds and specialized production runs.',
      image: media.plant,
    },
  ],
